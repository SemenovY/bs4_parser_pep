...
Их логирование и обработка. В парсерах есть две наиболее
...
# Импорт кастом класс ошибки, если не найден тег через find()
...
def get_response(session, url):
    """
    Реализуйте перехват ошибки RequestException в проекте parser_yap.
...
def find_tag(soup, tag, attrs=None):
    ...
    записать ошибку в логи. Для этого создайте функцию,
